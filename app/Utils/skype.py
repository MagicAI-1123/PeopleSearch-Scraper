...
class WebScraper:
    ...
    async def scrape_website(self): 
        try:
            ...
            try:
                self.driver.execute_script("document.getElementsByClassName('modal-dialog')[0].getElementsByClassName('btn btn-primary')[0].click()")
            except Exception as e:
...
async def run_scraper(_input_value, _input_type):
    ...
    #     # Send the formatted string as message
    #     return result_str
    # else:
